...
% clear
% 
% run Config_c230117.m
% load GeneratedCyc_HwPropFrom05to95.mat
% load theta_OperationResults_0124_0.mat
...
%% General Cyc Format
DrvCycKph = CYC_NREL2VAIL_kmph;
% load("opt_" + "CYC_combined1_kmph" + ".mat");
...
% SOC Drop Flag
figure
title('Batt Soc Ramp Under DrvCyc')
xlabel('Drive Step')
