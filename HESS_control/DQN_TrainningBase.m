...
ObservationInfo.Name = 'Vehicle and Powertrain States';
ObservationInfo.Description = 'v_dcsf, a_dcsf, P_h';
...
function [InitialObservation,LoggedSignals] = myResetFunction(envIndependState)
    ...
    InitialObservation = [v_ave_init; a_ave_init; P_h_init];
end
