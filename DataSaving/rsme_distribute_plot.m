load rsme_log_CYC_CYC_combined_230312_03.mat
load rsme_log_CYC_TU_kmph.mat
...
len_s = min(length(rsme_log_CYC_CYC_combined_230312_03), length(rsme_log_CYC_TU_kmph));
rsme_sum = -0.5 * (rsme_log_CYC_CYC_combined_230312_03(1:len_s) + rsme_log_CYC_TU_kmph(1:len_s));
...
for i = 1:n_shatter
    std_num_shatter(i) = mean(rsme_sum(l_ave:r_ave));
