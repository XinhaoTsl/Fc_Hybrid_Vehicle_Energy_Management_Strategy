...
for i=2:DrvCycLen
    ...
    BattSocRightNow(i) = BattSocRightNow(i-1) - SocDrop;
end

if BattSocRightNow(end) > BattSocLowerLimit
    BattOnly = 1;
else
    BattOnly = 0;
end
...
fprintf("%1.3f Battery SOC gonna be consumed.\n", (BattSocRightNow(1)-BattSocRightNow(end)));